...
class channel_attention(layers.Layer):
    ...
    def __init__(self, weight_decay=0.00000004, scope="", reuse=None,
                 **kwargs):  # deap H=120,W=24,C=256; dreamer H=123,W=9,C=256
...
def PrimaryCap(inputs, dim_capsule, n_channels, kernel_size, strides, padding, lam_regularize, model_version):
    ...
    if model_version == 'v2':  # MLF-CapsNet
        ...
        #抑制过拟合
        outputs = layers.SpatialDropout2D(rate=0.3, data_format='channels_last')(outputs)
